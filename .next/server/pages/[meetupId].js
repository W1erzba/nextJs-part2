...
async function getStaticPaths() {
    const client = await external_mongodb_.MongoClient.connect('mongodb+srv://Wierzba:wiadrokrowa1@cluster0.gfze6w8.mongodb.net/meetups?retryWrites=true&w=majority');
    const db = client.db();
